...
@section('subject', 'Edit Testimonial')
@section('content')
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title text-white">Edit Testimonial</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('testimoni.update', $testimoni->id) }}">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    id="name" name="name" value="{{ $testimoni->name }}">
                                @error('name')
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    id="from" name="from" value="{{ $testimoni->from }}">
                                @error('from')
                  ...
                  <div class="form-group">
                    ...
                    <textarea rows="3" class="form-control form-control-border border-width-2 @if(session('message')) is-invalid @endif @error('message') is-invalid @enderror" id="message" name="message">{{ $testimoni->message }}</textarea>
                    @error('message')
