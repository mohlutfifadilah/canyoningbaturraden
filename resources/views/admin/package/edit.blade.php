                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title text-white">Edit Package</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="rupiahInput" name="price" value="{{ $package->price }}">
                                            @error('price')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="location" name="location" value="{{ $package->location }}">
                                            @error('location')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="level" name="level" value="{{ $package->level }}">
                                            @error('level')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="experience" name="experience" value="{{ $package->experience }}">
                                            @error('experience')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="fitness" name="fitness" value="{{ $package->fitness }}">
                                            @error('fitness')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="swimming_abilities" name="swimming_abilities"
                                                value="{{ $package->swimming_abilities }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="time" name="time" value="{{ $package->time }}">
                                            @error('time')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="approach" name="approach" value="{{ $package->approach }}">
                                            @error('approach')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="return" name="return" value="{{ $package->return }}">
                                            @error('return')
